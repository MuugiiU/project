...
const ProductCard = ({ product }: any) => {
  return (
    <article className="rounded-xl  bg-white shadow-lg hover:shadow-xl hover:transform hover:scale-105 duration-300 ">
      <a href="#">
        <div className=" relative flex h-96 w-full gap-30 justify-between item-center rounded-xl">
          <img src={product.img} alt="photo" width={100} height={100} className="object-fit flex flex-1 " />
        </div>
